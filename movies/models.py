...
class Category(models.Model):
    ...
    slug = models.SlugField("Url", max_length=160, unique=True)
...
class RatingStar(models.Model):
    """Звезда рейтинга"""
    value = models.PositiveSmallIntegerField("Значение", default=0, unique=True)
...
class Rating(models.Model):
    ...
    star = models.ForeignKey(RatingStar, to_field='value', on_delete=models.CASCADE, verbose_name="звезда")
